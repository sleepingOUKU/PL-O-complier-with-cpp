...
vector<string> SYMArray(1000);
vector<string> IDArray(1000);
vector<string> NUMArray(1000);
int symArrayCount=0;
int idArrayCount=0;
int numArrayCount=0;
...
inline void getTargetCode(int op, int l, int a);
